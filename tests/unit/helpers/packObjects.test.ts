...
describe("packObjects: align", () => {
  ...
  /*
   * В заполнении строк нет, равнять не с чем, кроме самой области: уложенный
   * блок целиком уходит к нужному краю.
   */
  it("в заполнении двигается весь блок по ширине области", () => {
    const r = pack({
      layout: "fill",
      keys: ["a", "b"],
    ...
    // блок занял 80 из 200 — уезжает на 120
