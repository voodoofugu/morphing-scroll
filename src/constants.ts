const CONST = {
  ...
  /*
   * Стрелка едет со скоростью натива: Chromium доводит шаг примерно за столько
   * же, а удержанная клавиша копит цель, а не начинает каждый шаг заново.
   */
  KEY_PAN_DURATION: 120, // ms
  /*
