...
- ### Props:
  ...
  <details>
    <summary><strong><code>className</code></strong>:<br /><em>Additional classes for the component.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>children</code></strong>:<br /><em>Custom user content.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>type</code></strong>:<br /><em>Type of progress element.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>direction</code></strong>:<br /><em>Scrolling direction.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>scrollTop</code></strong>:<br /><em>Scroll position and animation duration.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>stopLoadOnScroll</code></strong>:<br /><em>Stop loading when scrolling.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>onScrollValue</code></strong>:<br /><em>Callback for scroll value.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>isScrolling</code></strong>:<br /><em>Callback function for scroll status.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>size</code></strong>:<br /><em>MorphScroll width and height.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>objectsSize</code> (required)</strong>:<br /><em>Required: Size of cells for each object.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>gap</code></strong>:<br /><em>Gap between cells.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>padding</code></strong>:<br /><em>Padding for the <code>objectsWrapper</code>.</em></summary><br />
    <ul>
      <strong>Type:</strong> number[] | number<br />
      <br />
      <strong>Description:</strong> <em><br />
  ...
  <details>
    <summary><strong><code>contentAlign</code></strong>:<br /><em>Aligns the content when it is smaller than the MorphScroll <code>size</code>.</em></summary><br />
    <ul>
      <strong>Type:</strong> [<br />
          "start" | "center" | "end",<br />
          "start" | "center" | "end"<br />
  ...
  <details>
    <summary><strong><code>elementsAlign</code></strong>:<br /><em>Aligns the objects within the <code>objectsWrapper</code>.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>edgeGradient</code></strong>:<br /><em>Gradient when scrolling overflows.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>progressReverse</code></strong>:<br /><em>Reverse the progress bar position.</em></summary><br />
    <ul>
      <strong>Type:</strong> boolean<br />
      <br />
      <strong>Default:</strong> false<br />
  ...
  <details>
    <summary><strong><code>progressVisibility</code></strong>:<br /><em>Visibility of the progress bar.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>objectsWrapFullMinSize</code></strong>:<br /><em>Sets the <code>min-height</code> CSS property of the <code>objectsWrapper</code> to match the height of the MorphScroll.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>progressTrigger</code></strong>:<br /><em>Triggers for the progress bar.</em></summary><br />
    <ul>
      <strong>Type:</strong> {<br />
        wheel?: boolean;<br />
        content?: boolean;<br />
  ...
  <details>
    <summary><strong><code>render</code></strong>:<br /><em>Types of rendering for optimization.</em></summary><br />
    <ul>
      <strong>Type:</strong><br />
        | { type: "default" }<br />
  ...
  <details>
    <summary><strong><code>emptyElements</code></strong>:<br /><em>Handling of empty scroll elements.</em></summary><br />
    <ul>
      <strong>Type:</strong><br />
        | {
            mode: "clear";
  ...
  <details>
    <summary><strong><code>suspending</code></strong>:<br /><em>Adds React Suspense.</em></summary><br />
    <ul>
      <strong>Type:</strong> boolean<br />
      <br />
      <strong>Default:</strong> false<br />
  ...
  <details>
    <summary><strong><code>fallback</code></strong>:<br /><em>Fallback element.</em></summary><br />
    <ul>
      <strong>Type:</strong> React.ReactNode<br />
      <br />
      <strong>Description:</strong> <em><br />
...
- ### Props:
  ...
  <details>
    <summary><strong><code>children</code></strong>:<br /><em>Render-prop function for size updates and adding content.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>style</code></strong>:<br /><em>Applies inline styles to the container.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>measure</code></strong>:<br /><em>Defines the measurement strategy.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>onResize</code></strong>:<br /><em>Callback triggered on size changes.</em></summary><br />
    <ul>
...
- ### Props:
  ...
  <details>
    <summary><strong><code>root</code></strong>:<br /><em>Defines the observation area.</em></summary><br />
    <ul>
  ...
  <details>
    <summary><strong><code>rootMargin</code></strong>:<br /><em>Sets the margin around the root element.</em></summary><br />
    <ul>
      <strong>Type:</strong> number | number[]<br />
      <br />
      <strong>Description:</strong> <em><br />
  ...
  <details>
    <summary><strong><code>threshold</code></strong>:<br /><em>Defines when the callback is triggered.</em></summary><br />
    <ul>
      <strong>Type:</strong> number | number[]<br />
      <br />
      <strong>Description:</strong> <em><br />
  ...
  <details>
    <summary><strong><code>visibleContent</code></strong>:<br /><em>Makes all elements always visible.</em></summary><br />
    <ul>
      <strong>Type:</strong> boolean<br />
      <br />
      <strong>Default:</strong> false<br />
  ...
  <details>
    <summary><strong><code>onVisible</code></strong>:<br /><em>Callback function triggered when the element becomes visible.</em></summary><br />
    <ul>
